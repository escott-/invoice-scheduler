...
git clone https://source.developers.google.com/p/invoice-1237 /opt/app

# Install app dependencies
mkdir /opt/app/invoice-scheduler
cd /opt/app/invoice-scheduler
npm install
...
[program:nodeapp]
directory=/opt/app/invoice-scheduler
command=npm start
autostart=true
autorestart=true
user=nodeapp
